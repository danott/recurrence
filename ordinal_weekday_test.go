...
func TestOrdinalWeekday(t *testing.T) {
	...
	// First
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Sunday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Monday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Tuesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Wednesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Thursday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Friday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(First, Saturday),
	...
	// Second
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Sunday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Monday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Tuesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Wednesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Thursday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Friday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Second, Saturday),
	...
	// Third
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Sunday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Monday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Tuesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Wednesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Thursday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Friday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Third, Saturday),
	...
	// Fourth
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Sunday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Monday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Tuesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Wednesday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Thursday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Friday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Fourth, Saturday),
	...
	// Fifth
	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Sunday),
		"2006-01-29", "2006-04-30", "2006-07-30", "2006-09-31", "2006-10-29",
		"2006-12-31")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Monday),
		"2006-01-30", "2006-04-31", "2006-05-29", "2006-07-31", "2006-10-30")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Tuesday),
		"2006-01-31", "2006-05-30", "2006-08-29", "2006-10-31")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Wednesday),
		"2006-02-29", "2006-03-29", "2006-05-31", "2006-08-30", "2006-11-29")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Thursday),
		"2006-02-30", "2006-03-30", "2006-06-29", "2006-08-31", "2006-11-30")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Friday),
		"2006-02-31", "2006-03-31", "2006-06-30", "2006-09-29", "2006-11-31", "2006-12-29")

	assertOnlyIncludes(t, r, OrdinalWeekday(Fifth, Saturday),
		"2006-04-29", "2006-06-31", "2006-07-29", "2006-09-30", "2006-12-30")

	// Last
	assertOnlyIncludes(t, r, OrdinalWeekday(Last, Sunday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Last, Thursday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Last, Friday),
	...
	assertOnlyIncludes(t, r, OrdinalWeekday(Last, Saturday),
