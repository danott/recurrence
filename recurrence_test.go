...
func assertIncludes(t *testing.T, d TemporalExpression, s ...string) {
	for _, s := range s {
		aTime, _ := time.Parse(f, s)
		if !d.Includes(aTime) {
			t.Errorf("%#v should have included %s", d, aTime)
		}
	}
}

func assertExcludes(t *testing.T, d TemporalExpression, s ...string) {
	for _, s := range s {
		aTime, _ := time.Parse(f, s)
		if d.Includes(aTime) {
			t.Errorf("%#v should have excluded %s", d, aTime)
		}
	}
}

func assertOnlyIncludes(t *testing.T, dr DateRange, te TemporalExpression, s ...string) {
	...
	for _, aDate := range dr.EachDate() {
		_, ok := include[aDate.Format(f)]
		if ok {
...
func TestWeekdayTE(t *testing.T) {
	jan_1_2006, _ := time.Parse(f, "2006-01-01")
	jan_31_2006, _ := time.Parse(f, "2006-01-31")
	dr := DateRange{jan_1_2006, jan_31_2006}

	assertOnlyIncludes(t, dr, WeekdayTE{Sunday},
		"2006-01-01", "2006-01-08", "2006-01-15", "2006-01-22", "2006-01-29")

	assertOnlyIncludes(t, dr, WeekdayTE{Monday},
		"2006-01-02", "2006-01-09", "2006-01-16", "2006-01-23", "2006-01-30")

	assertOnlyIncludes(t, dr, WeekdayTE{Tuesday},
		"2006-01-03", "2006-01-10", "2006-01-17", "2006-01-24", "2006-01-31")

	assertOnlyIncludes(t, dr, WeekdayTE{Wednesday},
		"2006-01-04", "2006-01-11", "2006-01-18", "2006-01-25")

	assertOnlyIncludes(t, dr, WeekdayTE{Thursday},
		"2006-01-05", "2006-01-12", "2006-01-19", "2006-01-26")

	assertOnlyIncludes(t, dr, WeekdayTE{Friday},
		"2006-01-06", "2006-01-13", "2006-01-20", "2006-01-27")

	assertOnlyIncludes(t, dr, WeekdayTE{Saturday},
		"2006-01-07", "2006-01-14", "2006-01-21", "2006-01-28")
}

func TestWeekdayInMonthTE(t *testing.T) {
	jan_1_2006, _ := time.Parse(f, "2006-01-01")
	dec_31_2006, _ := time.Parse(f, "2006-12-31")
	dr := DateRange{jan_1_2006, dec_31_2006}

	// First
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Sunday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Monday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Tuesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Wednesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Thursday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Friday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{First, Saturday},
	...
	// Second
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Sunday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Monday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Tuesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Wednesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Thursday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Friday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Second, Saturday},
	...
	// Third
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Sunday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Monday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Tuesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Wednesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Thursday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Friday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Third, Saturday},
	...
	// Fourth
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Sunday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Monday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Tuesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Wednesday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Thursday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Friday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fourth, Saturday},
	...
	// Fifth
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Sunday},
		"2006-01-29", "2006-04-30", "2006-07-30", "2006-09-31", "2006-10-29",
		"2006-12-31")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Monday},
		"2006-01-30", "2006-04-31", "2006-05-29", "2006-07-31", "2006-10-30")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Tuesday},
		"2006-01-31", "2006-05-30", "2006-08-29", "2006-10-31")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Wednesday},
		"2006-02-29", "2006-03-29", "2006-05-31", "2006-08-30", "2006-11-29")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Thursday},
		"2006-02-30", "2006-03-30", "2006-06-29", "2006-08-31", "2006-11-30")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Friday},
		"2006-02-31", "2006-03-31", "2006-06-30", "2006-09-29", "2006-11-31", "2006-12-29")

	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Fifth, Saturday},
		"2006-04-29", "2006-06-31", "2006-07-29", "2006-09-30", "2006-12-30")

	// Last
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Last, Sunday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Last, Thursday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Last, Friday},
	...
	assertOnlyIncludes(t, dr, WeekdayInMonthTE{Last, Saturday},
